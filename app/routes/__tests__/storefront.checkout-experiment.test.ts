...
// onto orders.attribution next to live_session_id. Bucketing (cookie-only ids, no coin
// flips for cookieless buyers, failure isolation) is the shared resolver's contract,
