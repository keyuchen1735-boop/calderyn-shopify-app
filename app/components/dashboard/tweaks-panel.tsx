...
export function TweakRadio<V = string>({
  label,
  value,
  options,
  onChange,
  ...
  const isObj = (o: TweakOption<V>): o is { value: V; label: string } =>
    typeof o === "object" && o !== null;
  const labelLen = (o: TweakOption<V>) => String(isObj(o) ? o.label : o).length;
  ...
  if (!fitsAsSegments) {
    ...
    const resolve = (s: string): V => {
      const m = options.find((o) => String(isObj(o) ? o.value : o) === s);
      return m === undefined ? (s as unknown as V) : isObj(m) ? m.value : m;
    };
    return (
      <TweakSelect
        label={label}
  ...
  const opts = options.map((o) => (isObj(o) ? o : { value: o, label: String(o) }));
...
export function TweakSelect<V = string>({
  label,
  value,
  options,
  onChange,
        ...
        {options.map((o) => {
          const obj =
            typeof o === "object" && o !== null && "value" in o && "label" in o
              ...
              : null;
          const v = obj ? obj.value : o;
          const l = obj ? obj.label : o;
          return (
