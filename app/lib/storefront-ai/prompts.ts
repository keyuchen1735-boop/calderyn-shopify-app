...
Allowed data-cd-repeat sources and keys are collection.products/product.id, featured.products/product.id, related.products/product.id, search.results/product.id, cart.lines/cartLine.id, product.images/product.primaryImage, and product.variants/variant.id. Do not invent repeat sources.
