...
const shell = route(
  ...
  `.atelier-header{position:sticky;top:0;z-index:20;display:grid;grid-template-columns:1fr auto 1fr;align-items:center;min-height:72px;padding:0 28px;background:#f3e9dc;border-bottom:1px solid #31201e}.atelier-header nav,.atelier-tools{display:flex;gap:24px}.atelier-tools{justify-content:flex-end}.atelier-header a,.atelier-footer a{color:inherit;text-decoration:none}.atelier-mark{font-family:var(--font-display);font-size:20px;font-weight:700;letter-spacing:.08em;text-transform:uppercase}.atelier-header nav,.atelier-tools{font-size:11px;letter-spacing:.08em;text-transform:uppercase}.atelier-footer{display:flex;justify-content:space-between;gap:24px;padding:36px 28px;background:#31201e;color:#f3e9dc}.atelier-footer nav{display:flex;flex-wrap:wrap;gap:18px}@media(max-width:760px){.atelier-header{grid-template-columns:1fr auto;padding:0 16px}.atelier-header nav{display:none}.atelier-tools a:first-child{display:none}}`,
);

const home = route(
  `<main class="atelier-home"><section class="atelier-hero" aria-labelledby="atelier-title"><img class="atelier-hero-image" data-cd-asset="hero" alt="Draped garment study in a calm studio" width="1600" height="900"><div class="atelier-hero-copy"><p>Garment study / live collection</p><h1 id="atelier-title"><span class="atelier-hero-line">Fit begins</span><span class="atelier-hero-line">with the cloth.</span></h1><span>Measured garments, calm essentials, and a size path that states what it knows.</span><a data-cd-route="collection">Study the current collection</a></div></section><section class="atelier-collection-hooks" aria-label="Collection discovery"><article><p>All garments</p><h2>Begin with the live collection.</h2><a data-cd-route="collection">Open live collection</a></article><article><p>Collection records</p><h2>Compare current garments.</h2><a data-cd-route="collections">View garment index</a></article><article><p>Search records</p><h2>Search by cut or cloth.</h2><a data-cd-route="search">Search records</a></article></section><section class="atelier-study"><div class="atelier-study-copy"><p>Fabric study</p><h2>Movement before ornament.</h2><span>Soft stone surfaces and an oxblood datum line keep attention on proportion, drape, and repeat wear.</span></div><div class="atelier-context-study" aria-hidden="true"></div></section><section class="atelier-garments"><header><p>Current garment records</p><h2>Live cuts, not sample copy.</h2></header><div class="atelier-garment-grid" data-cd-repeat="featured.products"><article data-cd-key="product.id"><a data-cd-route="product" data-cd-param-handle="product.handle"><img data-cd-src="product.primaryImage" data-cd-alt="product.title"><h3 data-cd-text="product.title"></h3><p data-cd-text="product.description"></p><p data-cd-money="product.price"></p><span data-cd-text="product.availability"></span></a></article></div><p class="atelier-empty" data-cd-empty-state>No garments are available in this study.</p></section></main><section data-cd-repeat="featured.products"><div data-cd-key="product.id" data-cd-slot="quickViewCommerce" data-cd-product="product.id" data-cd-host-size="inline" data-cd-theme-tokens="stone oxblood ink"></div></section>`,
  `.atelier-home{background:#f3e9dc;color:#31201e}.atelier-hero{position:relative;min-height:760px;overflow:hidden}.atelier-hero-image{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}.atelier-hero:after{content:'';position:absolute;inset:0;background:linear-gradient(90deg,#31201ea8,transparent 70%)}.atelier-hero-copy{position:absolute;z-index:2;left:6vw;bottom:9vh;max-width:650px;color:#f3e9dc}.atelier-hero-copy p,.atelier-study p,.atelier-garments header p{font-size:11px;letter-spacing:.12em;text-transform:uppercase}.atelier-hero h1{max-width:8ch;margin:14px 0;font-family:var(--font-display);font-size:clamp(3.875rem,9vw,6rem);font-weight:500;line-height:.82}.atelier-hero-copy span{display:block;max-width:44ch;line-height:1.6}.atelier-hero-copy a{display:inline-block;margin-top:24px;padding:14px 18px;background:#b72b34;color:#f3e9dc;text-decoration:none}.atelier-collection-hooks{display:grid;grid-template-columns:repeat(3,1fr);border-top:1px solid #31201e;border-bottom:1px solid #31201e;background:#f3e9dc}.atelier-collection-hooks article{min-height:250px;padding:28px;border-right:1px solid #31201e}.atelier-collection-hooks article:last-child{border-right:0}.atelier-collection-hooks h2{font-family:var(--font-display);font-size:36px;font-weight:500;line-height:.9}.atelier-collection-hooks a{display:inline-block;margin-top:18px;color:#b72b34}.atelier-study{display:grid;grid-template-columns:1fr 1.25fr;min-height:620px;border-bottom:1px solid #31201e}.atelier-study-copy{padding:8vw 6vw;background:#f3e9dc}.atelier-study h2,.atelier-garments h2{margin:18px 0;font-family:var(--font-display);font-size:clamp(48px,7vw,96px);font-weight:500;line-height:.86}.atelier-study-copy span{display:block;max-width:42ch;line-height:1.7}.atelier-context-study{min-height:440px;background:linear-gradient(135deg,#f3e9dc,#f3e9dc 48%,#b72b34)}.atelier-garments{padding:72px 28px}.atelier-garments header{display:flex;justify-content:space-between;align-items:end;gap:30px}.atelier-garment-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.atelier-garment-grid article{min-width:0;border-top:1px solid #31201e}.atelier-garment-grid a{color:inherit;text-decoration:none}.atelier-garment-grid img{width:100%;aspect-ratio:4/5;object-fit:cover}.atelier-garment-grid h3{margin:12px 0 4px;font-family:var(--font-display);font-size:24px;font-weight:500}.atelier-empty{padding:40px 0}@media(max-width:760px){.atelier-hero{min-height:680px}.atelier-collection-hooks{grid-template-columns:1fr}.atelier-collection-hooks article{min-height:0;border-right:0;border-bottom:1px solid}.atelier-study{grid-template-columns:1fr}.atelier-study-copy{padding:60px 20px}.atelier-garments{padding:55px 16px}.atelier-garments header{display:block}.atelier-garment-grid{display:flex;overflow-x:auto;scroll-snap-type:x mandatory}.atelier-garment-grid article{flex:0 0 76vw;scroll-snap-align:start}}@media(prefers-reduced-motion:reduce){.atelier-garment-grid{scroll-behavior:auto}}`,
);

const collections = route(
  `<main class="atelier-index"><header><p>Garment index</p><h1>Study every live garment.</h1></header><section class="atelier-index-composition" aria-label="Collection paths" data-cd-repeat="featured.collections"><article data-cd-key="collection.id"><span>Garment collection</span><h2 data-cd-text="collection.title"></h2><p>Merchant-bound collection pages keep live products, prices, and availability together.</p><a data-cd-route="collection" data-cd-param-handle="collection.handle">Open collection</a></article></section><section data-cd-repeat="featured.products"><article data-cd-key="product.id"><a data-cd-route="product" data-cd-param-handle="product.handle"><img data-cd-src="product.primaryImage" data-cd-alt="product.title"><h2 data-cd-text="product.title"></h2><span data-cd-money="product.price"></span></a></article></section></main>`,
  `.atelier-index{min-height:80vh;padding:70px 28px;background:#f3e9dc}.atelier-index header{display:grid;grid-template-columns:1fr 2fr;gap:30px;border-bottom:1px solid}.atelier-index h1{max-width:12ch;margin:0 0 50px;font-family:var(--font-display);font-size:clamp(54px,8vw,110px);font-weight:500;line-height:.83}.atelier-index-composition{display:grid;grid-template-columns:repeat(2,1fr);gap:1px;margin-top:24px;background:#31201e}.atelier-index-composition article{padding:24px;background:#f3e9dc}.atelier-index-composition h2{font-family:var(--font-display);font-size:38px;font-weight:500}.atelier-index-composition a{color:#b72b34}.atelier-index section:not(.atelier-index-composition){display:grid;grid-template-columns:repeat(4,1fr);gap:12px;padding-top:50px}.atelier-index article img{width:100%;aspect-ratio:4/5;object-fit:cover}.atelier-index article a{color:inherit;text-decoration:none}@media(max-width:760px){.atelier-index{padding:48px 16px}.atelier-index header,.atelier-index section:not(.atelier-index-composition){grid-template-columns:1fr 1fr}.atelier-index-composition{grid-template-columns:1fr}}`,
);
...
const collection = route(
  ...
  `.atelier-collection{padding:58px 28px;background:#f3e9dc}.atelier-collection>header{display:grid;grid-template-columns:1fr 2fr 1fr;gap:30px;align-items:end}.atelier-collection h1{margin:0;font-family:var(--font-display);font-size:clamp(58px,9vw,124px);font-weight:500;line-height:.82}.atelier-breadcrumbs,.atelier-sibling-nav{display:flex;flex-wrap:wrap;gap:12px;padding:12px 0}.atelier-breadcrumbs a,.atelier-sibling-nav a{color:#b72b34}.atelier-applied-filter{display:flex;justify-content:space-between;gap:24px;margin-top:26px;padding:14px;border:1px solid #31201e;background:#f3e9dc}.atelier-collection>nav:not(.atelier-breadcrumbs):not(.atelier-sibling-nav){display:flex;gap:20px;margin-top:20px;padding:16px 0;border-top:1px solid;border-bottom:1px solid}.atelier-collection button{padding:8px 0;border:0;background:none}.atelier-collection-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;padding-top:28px}.atelier-collection-grid article a{color:inherit;text-decoration:none}.atelier-collection-grid article img{width:100%;aspect-ratio:4/5;object-fit:cover}.atelier-collection-grid article h2{font-family:var(--font-display);font-size:30px;font-weight:500}.atelier-collection-grid article p{line-height:1.55}@media(max-width:760px){.atelier-collection{padding:42px 16px}.atelier-collection>header{grid-template-columns:1fr}.atelier-collection>nav{overflow:auto}.atelier-applied-filter{display:grid}.atelier-collection-grid{grid-template-columns:1fr 1fr}}`,
  "collection",
);
...
const search = route(
  ...
  `.atelier-search{min-height:80vh;padding:70px 28px;background:#f3e9dc}.atelier-search header{max-width:950px}.atelier-search h1{margin:16px 0;font-family:var(--font-display);font-size:clamp(58px,9vw,124px);font-weight:500;line-height:.82}.atelier-search-controls{display:flex;gap:8px;margin:40px 0}.atelier-search input{flex:1;padding:16px;border:0;border-bottom:1px solid;background:transparent;font-size:20px}.atelier-search button{padding:12px 18px;border:1px solid;background:transparent}.atelier-search article{display:grid;grid-template-columns:160px 1fr;gap:24px;padding:16px 0;border-top:1px solid}.atelier-search article img{width:160px;height:190px;object-fit:cover}.atelier-search article h2{font-family:var(--font-display);font-size:32px;font-weight:500}.atelier-search article a{display:block;margin-top:16px;color:#b72b34}.atelier-search-count{border-left:4px solid #b72b34;padding-left:12px}.atelier-search-recovery{display:flex;gap:16px;margin-top:28px}.atelier-search-recovery a{color:#b72b34}@media(max-width:760px){.atelier-search{padding:48px 16px}.atelier-search-controls{flex-wrap:wrap}.atelier-search article{grid-template-columns:100px 1fr}.atelier-search article img{width:100px;height:130px}}`,
  "search",
);

const story = route(
  `<main class="atelier-story"><header><p>Fit method</p><h1>Start with preference. Confirm the variant.</h1></header><section><article><h2>Start with cloth</h2><p>Fabric weight, stretch, and recovery can change how a silhouette feels in motion.</p></article><article><h2>Name your preference</h2><p>Use closer, regular, or relaxed as guidance for the silhouette you want.</p></article><article><h2>Confirm live facts</h2><p>The selected variant and its availability remain the purchase authority.</p></article></section><a data-cd-route="collection">Open the garment laboratory</a></main>`,
  `.atelier-story{min-height:80vh;padding:80px 6vw;background:#b72b34;color:#f3e9dc}.atelier-story header{max-width:1000px}.atelier-story h1{max-width:11ch;margin:18px 0 70px;font-family:var(--font-display);font-size:clamp(62px,9vw,132px);font-weight:500;line-height:.82}.atelier-story section{display:grid;grid-template-columns:repeat(3,1fr);border-top:1px solid #f3e9dc}.atelier-story article{min-height:300px;padding:26px;border-right:1px solid #f3e9dc}.atelier-story article h2{font-family:var(--font-display);font-size:36px;font-weight:500}.atelier-story article p{line-height:1.65}.atelier-story>a{display:inline-block;margin-top:40px;padding:14px 18px;background:#f3e9dc;color:#31201e;text-decoration:none}@media(max-width:760px){.atelier-story{padding:60px 16px}.atelier-story section{grid-template-columns:1fr}.atelier-story article{min-height:0;border-right:0;border-bottom:1px solid #f3e9dc}}`,
);

const cart = route(
  `<main><header class="atelier-cart-head"><p>Live order ledger</p><h1>Your garments.</h1><span><span data-cd-text="cart.count"></span> pieces</span></header>${cartProgress.html}<section data-cd-repeat="cart.lines"><article data-cd-key="cartLine.id"><div class="atelier-cart-line"><h2 data-cd-text="cartLine.title"></h2><span>Quantity <b data-cd-text="cartLine.quantity"></b></span><strong data-cd-money="cartLine.total"></strong></div><div data-cd-slot="cartLineControls" data-cd-host-size="inline" data-cd-theme-tokens="stone oxblood ink"></div></article></section><p class="atelier-empty" data-cd-empty-state>Your garment ledger is empty. <a data-cd-route="collection">Browse the live collection</a>.</p><aside class="atelier-cart-subtotal"><span>Subtotal</span><b data-cd-money="cart.subtotal"></b></aside><aside class="atelier-cart-policy"><b>Before checkout</b><p>Line quantities, subtotal, checkout progression, and merchant policy links stay visible before the protected checkout handoff.</p><nav data-cd-policy-links></nav></aside><div data-cd-slot="cartSummary" data-cd-host-size="page" data-cd-theme-tokens="stone oxblood ink"></div></main>`,
  `.atelier-cart-head{display:flex;justify-content:space-between;align-items:end;gap:20px;padding:70px 6vw 20px;background:#f3e9dc}.atelier-cart-head h1{margin:0;font-family:var(--font-display);font-size:clamp(62px,9vw,124px);font-weight:500;line-height:.82}.atelier-cart-progress{display:flex;justify-content:space-between;gap:20px;margin:40px 6vw;padding:18px;background:#b72b34;color:#f3e9dc}.atelier-cart-line{display:grid;grid-template-columns:1fr auto auto;gap:24px;align-items:center;padding:20px 6vw;border-top:1px solid}.atelier-cart-line h2{margin:0;font-family:var(--font-display);font-size:30px;font-weight:500}.atelier-cart-subtotal{display:flex;justify-content:flex-end;gap:40px;padding:24px 6vw;border-top:1px solid}.atelier-cart-policy{margin:0 6vw 28px;padding:18px;border:1px solid;background:#f3e9dc}.atelier-cart-policy nav{display:flex;flex-wrap:wrap;gap:14px}@media(max-width:760px){.atelier-cart-head{display:block;padding:50px 16px 20px}.atelier-cart-progress{display:grid;margin:30px 16px}.atelier-cart-line{grid-template-columns:1fr;padding:20px 16px}}`,
  "cart",
);
...
const checkout = {
  ...
  css: `.atelier-checkout{display:grid;grid-template-columns:2fr 1fr;min-height:480px;background-color:#f3e9dc;color:#31201e}.atelier-checkout header{padding:70px 48px}.atelier-checkout h1{max-width:640px;font-family:var(--font-display);font-size:64px;font-weight:500;line-height:.86}.atelier-checkout aside{padding:70px 34px;background-color:#b72b34;color:#f3e9dc}.atelier-checkout footer{display:flex;gap:18px;padding:20px;background-color:#31201e;color:#f3e9dc}.atelier-checkout footer a{color:#f3e9dc}@media(max-width:760px){.atelier-checkout{grid-template-columns:1fr}.atelier-checkout h1{font-size:48px}}`,
  layout: {
...
const notFound = route(
  `<main class="atelier-not-found"><p>Garment record unavailable</p><h1>This study is not on the table.</h1><span>The live collection may have changed.</span><a data-cd-route="collections">Return to the garment index</a></main>`,
  `.atelier-not-found{display:grid;place-content:center;min-height:80vh;padding:40px;background:#f3e9dc;text-align:center}.atelier-not-found h1{max-width:10ch;margin:18px auto;font-family:var(--font-display);font-size:clamp(62px,9vw,120px);font-weight:500;line-height:.82}.atelier-not-found a{justify-self:center;margin-top:26px;padding:14px 18px;background:#b72b34;color:#f3e9dc;text-decoration:none}`,
);
...
export const ATELIER_RECIPE_CONFIG = {
  ...
  designSystem: {
    ...
    globalCss: `.atelier-empty{padding:40px 0;line-height:1.5}.atelier-hero-line{display:block;line-height:.82}.atelier-hero-image{animation:atelier-curtain 1.4s cubic-bezier(.7,0,.2,1) both}.atelier-study{animation:atelier-fold linear both;animation-timeline:view();animation-range:entry 0 cover 55%}@keyframes atelier-curtain{from{clip-path:inset(0 50%)}to{clip-path:inset(0)}}@keyframes atelier-fold{from{clip-path:inset(0 0 0 45%)}to{clip-path:inset(0)}}@media(prefers-reduced-motion:reduce){.atelier-hero-image,.atelier-study{animation:none}}`,
  },
  archetype: {
