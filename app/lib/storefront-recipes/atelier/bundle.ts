...
const collections = route(
  `<main class="atelier-index"><header><p>Garment index</p><h1>Study every live garment.</h1></header><section class="atelier-index-composition" aria-label="Collection paths" data-cd-repeat="featured.collections"><article data-cd-key="collection.id"><span>Garment collection</span><h2 data-cd-text="collection.title"></h2><p>Merchant-bound collection pages keep live products, prices, and availability together.</p><a data-cd-route="collection" data-cd-param-handle="collection.handle">Open collection</a></article></section><section data-cd-repeat="featured.products"><article data-cd-key="product.id"><a data-cd-route="product" data-cd-param-handle="product.handle"><img data-cd-src="product.primaryImage" data-cd-alt="product.title"><h2 data-cd-text="product.title"></h2><span data-cd-money="product.price"></span></a></article></section><p class="atelier-empty" data-cd-empty-state>No garment studies are available.</p></main>`,
...
export const ATELIER_RECIPE_CONFIG = {
  ...
  designSystem: {
    ...
    globalCss: `.atelier-empty{padding:40px 0;line-height:1.5}.atelier-hero-line{display:block;line-height:.82}`,
  },
  archetype: {
