...
export const VOLT_RECIPE_CONFIG = {
  ...
  surfaces: {
    ...
    home: {
      ...
      source: route(`
        <main class="volt-page volt-home">
          ...
          <section class="volt-collection-hooks" ${motionAttributes("reveal")}><header><span class="volt-kicker">Collection discovery</span><h2 class="volt-display">Pick the entry point.</h2><p>Route shoppers into all products, available products, or a price-led scan without inventing categories.</p></header><div class="volt-collection-hook-grid"><a data-cd-route="collections"><span>01 / Systems index</span><b>Browse collection paths</b></a><a data-cd-route="collection"><span>02 / Live collection</span><b>Filter and sort products</b></a><a data-cd-route="search"><span>03 / Search recovery</span><b>Find a component</b></a></div></section>
          ${catalogProof.html}
    ...
    collections: {
      ...
      source: route(`
        <main class="volt-page volt-directory"><header><span class="volt-kicker">Catalog directory / collection discovery</span><h1 class="volt-display">Choose a system path.</h1><p>Start with all live products, available products, or a price-led scan. Each path remains bound to the merchant catalog.</p><nav class="volt-directory-routes" aria-label="Collection destinations"><a class="volt-button" data-cd-route="collection">All products</a><a class="volt-button volt-button-ghost" data-cd-route="collection">Available now</a><a class="volt-button volt-button-ghost" data-cd-route="collection">Price scan</a></nav></header><section class="volt-collection-index-grid" data-cd-repeat="featured.products"><article data-cd-key="product.id"><span class="volt-kicker">Live product signal</span><h2 data-cd-text="product.title"></h2><p data-cd-text="product.description"></p><b data-cd-money="product.price"></b><span data-cd-text="product.availability"></span><a data-cd-route="product" data-cd-param-handle="product.handle">View product</a></article></section><p class="volt-empty" data-cd-empty-state>No catalog entries are available.</p></main>
    ...
    checkout: {
      ...
      source: {
        html: `<section class="volt-checkout-frame"><header class="volt-checkout"><span>Checkout decoration / encrypted handoff</span><h1 data-cd-text="store.name"></h1><p>Your live cart, pricing, delivery, and payment remain controlled by the platform through checkout.</p></header><aside class="volt-checkout-proof"><b>System continuity</b><span>Selected variants retained</span><span>Final totals shown by checkout</span></aside><footer data-cd-policy-links></footer></section>`,
