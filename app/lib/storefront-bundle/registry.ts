...
const VERSIONED_ASSET_MANIFESTS_BY_TEMPLATE_ID = {
  ...
  volt: [VOLT_ASSETS, VOLT_ASSETS],
  atelier: [ATELIER_ASSETS, ATELIER_ASSETS],
  gilt: [GILT_ASSETS, GILT_ASSETS],
  ember: [EMBER_ASSETS, EMBER_ASSETS],
  roast: [ROAST_ASSETS, ROAST_ASSETS],
  fizz: [FIZZ_ASSETS, FIZZ_ASSETS],
  forge: [FORGE_ASSETS, FORGE_ASSETS],
  haven: [HAVEN_ASSETS, HAVEN_ASSETS],
  glow: [GLOW_ASSETS, GLOW_ASSETS],
