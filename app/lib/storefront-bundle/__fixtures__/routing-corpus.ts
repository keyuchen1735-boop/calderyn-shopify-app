...
export const REQUIRED_ROUTING_CORPUS: readonly RoutingCorpusFixture[] = [
  ...
  { name: "negative Larder and product uniqueness", prompt: "Do not use Larder; create something one of a kind", expectedKind: "recipe", templateId: "custom-bench" },
  { name: "one of a kind is product language", prompt: "One-of-a-kind engraved gifts", expectedKind: "recipe", templateId: "custom-bench" },
  { name: "unique does not force custom", prompt: "Use Larder and make it unique", expectedKind: "recipe", templateId: "larder" },
  ...
  { name: "positive name after negative name", prompt: "Don't use Larder; use Soft Chemistry", expectedKind: "recipe", templateId: "soft-chemistry" },
  ...
  { name: "coordinated negated designs", prompt: "Do not use Larder or Soft Chemistry; build a clean skincare store", expectedKind: "recipe", templateId: "custom-bench" },
