...
export const REQUIRED_ROUTING_CORPUS: readonly RoutingCorpusFixture[] = [
  ...
  { name: "wireless audio ecosystem", prompt: "A wireless audio ecosystem with connected speakers", expectedKind: "recipe", templateId: "volt" },
  { name: "elevated wardrobe basics", prompt: "Elevated basics with an apparel fit finder", expectedKind: "recipe", templateId: "atelier" },
  { name: "fine jewelry gifting", prompt: "Fine jewelry with engraving and recipient gifting", expectedKind: "recipe", templateId: "gilt" },
  { name: "hot sauce tasting", prompt: "A hot sauce tasting flight organized by heat level", expectedKind: "recipe", templateId: "ember" },
  { name: "specialty coffee brewing", prompt: "A specialty coffee roaster organized by brew method", expectedKind: "recipe", templateId: "roast" },
  { name: "functional soda", prompt: "Functional soda and non alcoholic variety packs", expectedKind: "recipe", templateId: "fizz" },
  { name: "professional hand tools", prompt: "Professional hand tools with project kit compatibility", expectedKind: "recipe", templateId: "forge" },
  { name: "modular furniture", prompt: "Modern modular furniture with a room fit checker", expectedKind: "recipe", templateId: "haven" },
  { name: "clinical skincare", prompt: "Clinical skincare with an ingredient glossary and skin routine", expectedKind: "recipe", templateId: "glow" },
  { name: "subscription pantry", prompt: "Subscription pantry staples with a build a box", expectedKind: "recipe", templateId: "larder" },
  ...
  { name: "unique does not force custom", prompt: "Use Atelier and make it unique", expectedKind: "recipe", templateId: "atelier" },
  ...
  { name: "except design exclusion", prompt: "Anything except Soft Chemistry; build a clean skincare store", expectedKind: "recipe", templateId: "custom-bench" },
  { name: "except-for design exclusion", prompt: "Anything except for Soft Chemistry; build a clean skincare store", expectedKind: "recipe", templateId: "custom-bench" },
  { name: "but design exclusion", prompt: "Anything but Soft Chemistry; build a clean skincare store", expectedKind: "recipe", templateId: "custom-bench" },
  { name: "exclude design exclusion", prompt: "Exclude Soft Chemistry; build a clean skincare store", expectedKind: "recipe", templateId: "custom-bench" },
  { name: "no design exclusion", prompt: "No Soft Chemistry; build a clean skincare store", expectedKind: "recipe", templateId: "custom-bench" },
  { name: "except clause stays positive", prompt: "Except for the colors, use Soft Chemistry", expectedKind: "recipe", templateId: "soft-chemistry" },
  { name: "nothing-except stays positive", prompt: "Use nothing except Soft Chemistry", expectedKind: "recipe", templateId: "soft-chemistry" },
  { name: "nothing-but stays positive", prompt: "Use nothing but Soft Chemistry", expectedKind: "recipe", templateId: "soft-chemistry" },
  { name: "exclude nothing stays positive", prompt: "Exclude nothing; use Soft Chemistry", expectedKind: "recipe", templateId: "soft-chemistry" },
  { name: "do-not-exclude stays positive", prompt: "Do not exclude Soft Chemistry", expectedKind: "recipe", templateId: "soft-chemistry" },
  { name: "no-change stays positive", prompt: "No changes to Soft Chemistry", expectedKind: "recipe", templateId: "soft-chemistry" },
