-- Test-DB parity mirror of supabase/migrations/20260502000043_campaign_grade.sql.
-- Required by tests/engine/unit/test_campaign_grade_writer.py, which was failing
-- in CI with "relation public.campaign_grade_fact does not exist" because this
-- analytics-port table was never added to the engine test schema.
